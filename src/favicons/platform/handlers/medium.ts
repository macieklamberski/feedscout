...
import {
  ...
  tagRegex,
  userRegex,
} from '../../../feeds/platform/handlers/medium.js'
...
const getFeedUrl = (url: string): string | undefined => {
  ...
  return `https://medium.com/feed/${publicationMatch[1]}`
}

export const mediumHandler: PlatformHandler = {
  match: (url) => {
    return !!getFeedUrl(url)
  },
