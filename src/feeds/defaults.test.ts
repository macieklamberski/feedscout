...
describe('defaultHtmlOptions ignores subscribe/share links that wrap a feed URL', () => {
  ...
  it('should still discover a same-site feed link matched by label', () => {
  ...
  it('should still discover a WordPress query feed (no embedded URL)', () => {
...
describe('defaultHtmlOptions ignores links to audio and video files', () => {
  ...
  it('should ignore an episode behind a tracking prefix with a feed segment', () => {
    const value =
  ...
  it('should ignore a media file with a query string', () => {
  ...
  it('should still discover a feed named after a media format', () => {
...
describe('defaultHtmlOptions matches feed path segments in the pathname only', () => {
  it('should discover an anchor with a feed segment in the path', () => {
  ...
  it('should ignore a feed segment that only appears in the query string', () => {
...
describe('defaultHtmlOptions does not treat "subscribe" alone as a feed label', () => {
  ...
  it('should still discover a "Subscribe via RSS" link via the rss label', () => {
